...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    //background color
    UIColor *newBackgroundColor = [UIColor colorWithRed:81.0/255 green:10.0/255 blue:81.0/255 alpha:1]; //setting the parameters for getting purple
    UIColor *newCellColor = [UIColor colorWithRed:150.0/255 green:0.0/255 blue:254.0/255 alpha:1];
